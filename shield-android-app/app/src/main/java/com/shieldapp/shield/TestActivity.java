...
public class TestActivity extends AppCompatActivity implements OnMapReadyCallback, LocationListener, View.OnClickListener {
    ...
    private PopupWindow modeOfTransport, officeCab, dialogAlert;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ImageView imageView = (ImageView) findViewById(R.id.headerbg);
        headerHeight = imageView.getHeight();
...
//        modes_next_btn.setOnClickListener(this);
    ...
    private void showPopupDialog() {
        ...
        dialogAlert.showAtLocation(constraintLayout, Gravity.TOP,0,250);
    }
